...
//function which collects data and then updates the buffers and calculates the moving averages
...
//function to setup the dispplay screen with text
...
//function to display data when a button is pressed
